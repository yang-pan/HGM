...
public class BroadcastCommand {
	...
	public final static String ACTION_GATT_CONNECTED 			= "co.megachps.hybridgpsmonitor.ACTION_GATT_CONNECTED";
	public final static String ACTION_GATT_DISCONNECTED 		= "co.megachps.hybridgpsmonitor.ACTION_GATT_DISCONNECTED";
	public final static String ACTION_GATT_SERVICES_DISCOVERED 	= "co.megachps.hybridgpsmonitor.ACTION_GATT_SERVICES_DISCOVERED";
	public final static String ACTION_DATA_AVAILABLE 			= "co.megachps.hybridgpsmonitor.ACTION_DATA_AVAILABLE";
	public final static String ACTION_BLE_STATUS_RESULT 		= "co.megachps.hybridgpsmonitor.ACTION_BLE_STATUS_RESULT";
	public final static String ACTION_BLE_SEND_REQUEST_DENIED 	= "co.megachps.hybridgpsmonitor.ACTION_BLE_SEND_REQUEST_DENIED";
	public final static String DATA_RECEIVED_FROM_ACTIVITY 		= "co.megachps.hybridgpsmonitor.DATA_RECEIVED_FROM_ACTIVITY";
	public final static String DEVICE_DOES_NOT_SUPPORT_UART 	= "co.megachps.hybridgpsmonitor.DEVICE_DOES_NOT_SUPPORT_UART";
	public final static String EXTRA_DATA 						= "co.megachps.hybridgpsmonitor.EXTRA_DATA";
