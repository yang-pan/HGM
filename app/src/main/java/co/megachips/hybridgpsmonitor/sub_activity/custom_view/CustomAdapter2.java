 ...
 */
public class CustomAdapter2 extends ArrayAdapter<CustomItemData2>{

	private LayoutInflater layoutInflater_;

	public CustomAdapter2(Context context, int textViewResourceId, List<CustomItemData2> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CustomItemData2 item = (CustomItemData2)getItem(position);
